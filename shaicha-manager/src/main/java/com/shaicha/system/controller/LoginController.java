...
import com.shaicha.common.domain.FileDO;
import com.shaicha.common.domain.Tree;
import com.shaicha.common.service.FileService;
import com.shaicha.common.utils.MD5Utils;
import com.shaicha.common.utils.R;
import com.shaicha.common.utils.ShiroUtils;
import com.shaicha.system.domain.MenuDO;
import com.shaicha.system.service.MenuService;
	...
	String index(Model model) {
		...
		if(fileDO!=null&&fileDO.getUrl()!=null){
			if(fileService.isExist(fileDO.getUrl())){
				...
				model.addAttribute("picUrl","/img/64d7b56ec03c3799df3da8be04c3cb7.jpg");
			}
		}else {
