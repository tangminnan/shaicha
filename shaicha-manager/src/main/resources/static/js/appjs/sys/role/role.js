									...
									formatter : function(value, row, index) {
										...
										str +=' <div class="switch onoffswitch col-sm-1"> ';
											str +=' <div class="onoffswitch"> ';
												...
												str +=' type="checkbox" onchange="updateEnable(' +row.roleId+ ',this)" value="' +row.roleId+ '" class="onoffswitch-checkbox" id="example1' +row.roleId+ '">  ';
												str +=' <label class="onoffswitch-label" for="example1' +row.roleId+ '">  ';
