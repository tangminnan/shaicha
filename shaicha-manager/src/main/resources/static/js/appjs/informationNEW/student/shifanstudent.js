...
function shaichajieguodaochu(){
	...
	window.location.href="/informationNEW/student/shifanshaichajieguodaochu?ids="+ids
	
}

function erweimaxiazaibyliulanqi(id){
	//window.location.href="/information/student/downLoadErWeiMaByBrower?id="+id
	window.open("/informationNEW/student/downLoadErWeiMaByBrower?id="+id);
}
...
function shifanshaichadayin(id,lastCheckTime){
	...
	window.open("/informationNEW/student/shifanshaichadayin?id="+id);
}
...
function yuce(){
	...
	window.open("/informationNEW/student/shifanyuce?id="+ids[0],"_blank")
