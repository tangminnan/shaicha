	...
	.bootstrapTable(
			{
				...
				url : "/informationNEW/resultEyesight/getUserDetail/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
...
//						endTime:$('#endTime').val()
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/informationNEW/resultEyeaxis/getUserDetail/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/informationNEW/resultEyepressure/getUserDetail/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/informationNEW/resultVisibility/getUserDetail/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/informationNEW/resultAdjusting/getUserDetail/"+identityCard, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
	...
	.bootstrapTable(
			{
				method : 'get', // 服务器数据的请求方式 get or post
				url : "/informationNEW/resultCorneal/getUserDetail/"+id, // 服务器数据的加载地址
			//	showRefresh : true,
			//	showToggle : true,
			//	showColumns : true,
				iconSize : 'outline',
